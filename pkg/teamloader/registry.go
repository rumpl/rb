...
import (
	...
	"github.com/rumpl/rb/pkg/gateway"
	"github.com/rumpl/rb/pkg/js"
	"github.com/rumpl/rb/pkg/memory/database/sqlite"
	"github.com/rumpl/rb/pkg/path"
	"github.com/rumpl/rb/pkg/tools"
	"github.com/rumpl/rb/pkg/tools/builtin"
	"github.com/rumpl/rb/pkg/tools/mcp"
)
...
func createMCPTool(ctx context.Context, toolset latest.Toolset, parentDir string, envProvider environment.Provider, runtimeConfig config.RuntimeConfig) (tools.ToolSet, error) {
	...
	if toolset.Ref != "" {
		...
		// TODO(dga): until the MCP Gateway supports oauth with rb, we fetch the remote url and directly connect to it.
