...
type HandoffArgs struct {
	Agent string `json:"agent" jsonschema:"The name of the agent to hando off the conversation to."`
}
	...
	return []tools.Tool{
		{
			...
			Category:    "handoff",
			Description: `Use this function to hando off the conversation to the selected team member.`,
