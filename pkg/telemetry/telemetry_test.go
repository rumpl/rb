...
func TestAllEventTypes(t *testing.T) {
	...
	for i, req := range requests {
		...
		assert.Equal(t, "rb/test-version", req.Header.Get("User-Agent"), "Request %d: Expected User-Agent rb/test-version", i)
...
func TestHTTPRequestVerification(t *testing.T) {
	...
	t.Run("CommandEventHTTPRequest", func(t *testing.T) {
		...
		assert.Equal(t, "rb/test-version", req.Header.Get("User-Agent"), "Expected User-Agent rb/test-version")
